...
internal class ApiClient(
    ...
    fun sendChatAction(chatId: ChatId, messageThreadId: Long?, action: ChatAction): TelegramBotResult<Boolean> {
        return service.sendChatAction(chatId, messageThreadId, action).runApiOperation()
    }
